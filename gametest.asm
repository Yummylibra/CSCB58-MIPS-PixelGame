...
#
# Student: private information, Student Number: private information, UTorID: private information, official email:private information
#
...
#	K. the player is about to do 1 more jump in the air, but will not keep jumping infinitely. The player can jump at max twice.
...
main_keypress:
	...
	li	$a0,0xffff0000		
	lw	$t0, 4($a0)# I do not understand this. I cope it from the project example in quercus
	...
	key_d:
		...
		addi	$t1, $t1, 63					# need to check if the mod is the row size - 12*4 (width of plane-1)
